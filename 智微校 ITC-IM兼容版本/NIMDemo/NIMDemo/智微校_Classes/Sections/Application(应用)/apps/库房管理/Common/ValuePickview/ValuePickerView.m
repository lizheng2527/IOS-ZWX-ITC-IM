...
- (void)initSubViews
{
    ...
    self.finishBtn.layer.cornerRadius = 3.0f;
    self.finishBtn.backgroundColor = [UIColor colorWithRed:43/255.0 green:100/255.0 blue:150/255.0 alpha:0.8];
    ...
    self.cancelBtn.backgroundColor = [UIColor colorWithRed:43/255.0 green:100/255.0 blue:150/255.0 alpha:0.8];
    ...
    UIView *lineview = [[UIView alloc]initWithFrame:CGRectMake(0, 44, [UIScreen mainScreen].bounds.size.width, 0.8f)];
    lineview.backgroundColor = UIColorFromRGB(0xe5e5e5);
    [self.controllerToolBar addSubview:lineview];
}
...
- (void)layoutSelfSubviews
{
    ...
    //控制栏
    self.controllerToolBar.frame = CGRectMake(0, 0, SCREEN_WIDTH, 45);
    
    //完成按钮
    self.finishBtn.frame = CGRectMake(SCREEN_WIDTH - 50, 9.f, 40, 27);
    
    //取消按钮
    self.cancelBtn.frame = CGRectMake(10, 9.f, 40, 27);
    
    //标题
    self.titleLabel.frame = CGRectMake(70, 7.5, SCREEN_WIDTH - 140, 30);
}
...
- (void)show
{
    if ([self.appType isEqualToString:@"青蚕学堂"]) {
        self.finishBtn.backgroundColor = [UIColor colorWithRed:95/255.0 green:206/255.0 blue:156/255.0 alpha:1];
        self.cancelBtn.backgroundColor = [UIColor colorWithRed:95/255.0 green:206/255.0 blue:156/255.0 alpha:1];
    }
    if ([self.appType isEqualToString:@"订车管理"]) {
