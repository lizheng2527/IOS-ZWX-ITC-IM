...
//        _mSymbolBtn.right = _mAddBtn.left - SSChatBtnDistence;
        _mSymbolBtn.right = SCREEN_WIDTH - 1.5 *SSChatBtnDistence;
        ...
        _mTextBtn.bounds = CGRectMake(0, 0, SSChatTextWidth + 2 * SSChatBtnSize , SSChatTextHeight);
//        _mTextBtn.left = _mLeftBtn.right+SSChatBtnDistence;
        _mTextBtn.left = SSChatBtnDistence * 2;
