//
//  RepairManagementMainController.m
//  NIM
//
...
@interface RepairManagementMainController ()<UIScrollViewDelegate>
...
@implementation RepairManagementMainController
...
- (NSMutableArray *)dataArray {
    ...
    if (_dataArray == nil) {
        ...
        NSArray * array = [NSArray arrayWithObjects:@{@"title":@"全部",@"status":@"0"},@{@"title":@"待处理",@"status":@"0"},@{@"title":@"已派单",@"status":@"0"},@{@"title":@"已完成",@"status":@"0"}, @{@"title":@"费用审批",@"status":@"0"},nil];
...
-(void)initView
{
    ...
    self.topScrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, AdjustHeight, [UIScreen mainScreen].bounds.size.width, 50)];
...
- (void)setupChildVc {
    for (int i = 0; i <= _indexAll; i ++) {
        RepairManagementDetailController * ContentView = [[RepairManagementDetailController alloc] init];
