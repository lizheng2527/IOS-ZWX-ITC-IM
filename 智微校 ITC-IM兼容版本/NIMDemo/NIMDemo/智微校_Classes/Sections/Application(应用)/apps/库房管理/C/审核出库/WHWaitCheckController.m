...
- (NSMutableArray *)dataArray {
    ...
    if (_dataArray == nil) {
        ...
        NSArray * array = [NSArray arrayWithObjects:@{@"title":@"部门",@"status":@"0"},@{@"title":@"总务",@"status":@"0"},nil];
...
-(void)initView
{
    ...
    self.contentScrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 50 + 64, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height - 50)];
