    ...
    [sheet showInView:self.view completionHandler:^(NSInteger index) {
        ...
        switch (index) {
            ...
            case 1:{  //创建高级群
                ...
                UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"请输入群名称" message:nil delegate:nil cancelButtonTitle:@"取消" otherButtonTitles:@"确认", nil];
                ...
                [alert showAlertWithCompletionHandler:^(NSInteger idx) {
                    ...
                    }else
                    {
                        [wself presentMemberSelector:^(NSArray *uids) {
                            ...
                            content = [content length] ? content : @"高级群";
                            option.name = content;
