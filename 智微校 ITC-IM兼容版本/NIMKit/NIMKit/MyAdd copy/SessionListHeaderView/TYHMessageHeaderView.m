...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _timeLabel.frame = CGRectMake(NIMKit_UIScreenWidth - 155, 15, 120, 18);
...
//        _lineLabel = [[UILabel alloc] initWithFrame:CGRectMake(18, 68, [UIScreen mainScreen].bounds.size.width - 18, 2.f)];
        _lineLabel = [[UILabel alloc] initWithFrame:CGRectMake(16, 64, [UIScreen mainScreen].bounds.size.width , .6f)];
        _lineLabel.backgroundColor = [UIColor colorWithRed:1/255.0 green:1/255.0 blue:1/255.0 alpha:0.3];
...
- (void)layoutSubviews{
    ...
    _timeLabel.nim_right         = self.nim_width - sessionListTimeRight - 6;
