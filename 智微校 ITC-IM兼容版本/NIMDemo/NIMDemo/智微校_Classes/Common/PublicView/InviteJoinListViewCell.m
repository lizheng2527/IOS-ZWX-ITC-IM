...
//    _portraitImg.image = [UIImage imageNamed:@"mk-photo"];
//    [_portraitImg sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",BaseURL,contact.headPortraitUrl]] placeholderImage:[UIImage imageNamed:@"mk-photo"]];
    
    [self.portraitImg sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",BaseURL,contact.headPortraitUrl]] placeholderImage:[UIImage imageNamed:@"mk-photo"]];
